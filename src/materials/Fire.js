...
export default class FireMaterial {
  constructor(perlinTexture, gui) {
    ...
    this.material = new THREE.ShaderMaterial({
      ...
      uniforms: {
        ...
        uFireFirstColor: new THREE.Uniform(new THREE.Color(this.debugObject.fireFirstColor)),
        uFireSecondColor: new THREE.Uniform(new THREE.Color(this.debugObject.fireSecondColor)),
        uFireTopColor: new THREE.Uniform(new THREE.Color(this.debugObject.fireTopColor)),
        uFireTopIntensity: new THREE.Uniform(this.debugObject.fireTopIntensity),
        uDistortWavyMotion: new THREE.Uniform(this.debugObject.distortWavyMotion),
  ...
  setupGUI(gui) {
    ...
    fireFolder.addColor(this.debugObject, "fireFirstColor").onChange(() => {
      this.material.uniforms.uFireFirstColor.value.set(this.debugObject.fireFirstColor);
    });
    
    fireFolder.addColor(this.debugObject, "fireSecondColor").onChange(() => {
      this.material.uniforms.uFireSecondColor.value.set(this.debugObject.fireSecondColor);
    });
    
    fireFolder.addColor(this.debugObject, "fireTopColor").onChange(() => {
      this.material.uniforms.uFireTopColor.value.set(this.debugObject.fireTopColor);
    });
    ...
    fireFolder
      ...
      .step(0.1)
      .onChange(() => {
        this.material.uniforms.uFireTopIntensity.value = this.debugObject.fireTopIntensity;
      });
    ...
    fireFolder
      ...
      .step(0.01)
      .onChange(() => {
        this.material.uniforms.uDistortWavyMotion.value = this.debugObject.distortWavyMotion;
      });
    ...
    fireFolder
      ...
      .step(0.01)
      .onChange(() => {
        this.material.uniforms.uRisingSpeed.value = this.debugObject.risingSpeed;
      });
    ...
    fireFolder
      ...
      .step(0.1)
      .onChange(() => {
        this.material.uniforms.uFireIntensity.value = this.debugObject.fireIntensity;
      });
  }
